...
const IndexTableWithViewsSearchFilterSorting = forwardRef((props, ref) => {
    ...
    const orders = [
        {
            id: '1020',
            title: (
                <Text as="span" variant="bodyMd" fontWeight="">
                   HomePage
                </Text>
            ),
            product: '0',
    ...
    const rowMarkup = orders.map(
        ({ id, title, product, productCondition }, index) => (
            <IndexTable.Row
                id={id}
                key={id}
...
IndexTableWithViewsSearchFilterSorting.displayName = 'IndexTableWithViewsSearchFilterSorting';
